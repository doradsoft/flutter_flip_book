...
class PageSemantics {
  ...
  PageSemantics(
      {required this.indexToSemanticName,
      required this.indexToTitle,
      required this.semanticNameToIndex});
}
...
typedef PageBuilder = Widget Function(BuildContext context, Size pageSize,
    int pageIndex, String? semanticPageName);
